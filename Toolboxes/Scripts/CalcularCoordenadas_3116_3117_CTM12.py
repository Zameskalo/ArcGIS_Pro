...
arcpy.management.AddFields(
    in_table=capaPuntos,
    field_description="X_3116 DOUBLE # # # #;Y_3116 DOUBLE # # # #;X_3117 DOUBLE # # # #;Y_3117 DOUBLE # # # #;X_CTM12 DOUBLE # # # #;Y_CTM12 DOUBLE # # # #;LON_GD DOUBLE # # # #;LAT_GD DOUBLE # # # #;LON_GMS TEXT # # # #;LAT_GMS TEXT # # # #",
    template=None
)
...
arcpy.management.CalculateGeometryAttributes(
    in_features=capaPuntos,
    geometry_property="X_3117 POINT_X",
    length_unit="",
    area_unit="",
...
arcpy.management.CalculateGeometryAttributes(
    in_features=capaPuntos,
    geometry_property="Y_3117 POINT_Y",
    length_unit="",
    area_unit="",
    coordinate_system='PROJCS["MAGNA_Colombia_Este",GEOGCS["GCS_MAGNA",DATUM["D_MAGNA",SPHEROID["GRS_1980",6378137.0,298.257222101]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Transverse_Mercator"],PARAMETER["False_Easting",1000000.0],PARAMETER["False_Northing",1000000.0],PARAMETER["Central_Meridian",-71.07750791666666],PARAMETER["Scale_Factor",1.0],PARAMETER["Latitude_Of_Origin",4.596200416666666],UNIT["Meter",1.0]]',
    coordinate_format="SAME_AS_INPUT"
...
arcpy.management.CalculateGeometryAttributes(
    in_features=capaPuntos,
    geometry_property="LON_GD POINT_X",
    length_unit="",
    area_unit="",
...
arcpy.management.CalculateGeometryAttributes(
    in_features=capaPuntos,
    geometry_property="LAT_GD POINT_Y",
    length_unit="",
    area_unit="",
    coordinate_system='GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]]',
    coordinate_format="SAME_AS_INPUT"
